...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_box_autoadd_log_entry(
      LogEntry apiObj, ffi.Pointer<wire_LogEntry> wireObj) {
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_dummyPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Pointer<wire_LogEntry>)>>('wire_dummy');
  late final _wire_dummy = _wire_dummyPtr
      .asFunction<void Function(int, ffi.Pointer<wire_LogEntry>)>();
  ...
  late final _new_box_autoadd_log_entry_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_LogEntry> Function()>>(
          'new_box_autoadd_log_entry_0');
  late final _new_box_autoadd_log_entry_0 = _new_box_autoadd_log_entry_0Ptr
      .asFunction<ffi.Pointer<wire_LogEntry> Function()>();
